...
export const LINK_COLOR = "#6FCF97";
export const LINE_COLOR = "#ABB5BE";
...
export const MOUSEWHEEL_DELTA_THROTTLE = 0.2;
export const STEP_VERTICAL_DISTANCE = 75;
export const STEP_HORIZONTAL_DISTANCE = 41;
